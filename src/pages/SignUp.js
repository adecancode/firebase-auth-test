    ...
    return (
        ...
        <ToastContainer/>
            <div className="w-full sm:w-full md:w-1/2 lg:w-1/3 xl:w-1/4 2xl:w-1/4 rounded-lg mx-auto mt-16 p-8 bg-gray-50">
                <p className="text-center font-bold text-gray-800 text-xl">Sign Up</p>
                ...
                <p className="text-center mt-8 text-sm text-gray-500">Already Have An Account? <Link  to="/login" className="text-purple-600 font-semibold">Login</Link></p>
            </div>
        </div>
    )
}
